	...
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="connoisseur">
				...
				<!-- banner 表格 显示 -->
				<form action="getcontactrecord/add" method="post">
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td width="300px"><input type="text" class="vinput mh_date" readonly="true" style="width: 210px"  name="contactLogsLastTime"></td>
